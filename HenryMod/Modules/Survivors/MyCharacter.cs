...
namespace HenryMod.Modules.Survivors
{
    internal class MyCharacter : SurvivorBase
    {
        ...
        internal override BodyInfo bodyInfo { get; set; } = new BodyInfo
        {
            ...
            armorGrowth = 0f,
            bodyName = "HenryBody",
            bodyNameToken = EelPlugin.developerPrefix + "_HENRY_BODY_NAME",
            ...
            jumpCount = 1,
            maxHealth = 110f,
            subtitleNameToken = EelPlugin.developerPrefix + "_HENRY_BODY_SUBTITLE",
        ...
        internal override void InitializeSkills()
        {
            ...
            string prefix = EelPlugin.developerPrefix;
        ...
        internal override void InitializeSkins()
        {
            ...
            #region DefaultSkin
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(EelPlugin.developerPrefix + "_HENRY_BODY_DEFAULT_SKIN_NAME",
            ...
            SkinDef masterySkin = Modules.Skins.CreateSkinDef(EelPlugin.developerPrefix + "_HENRY_BODY_MASTERY_SKIN_NAME",
