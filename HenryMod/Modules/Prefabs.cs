...
namespace HenryMod.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            string fullNameString = EelPlugin.developerPrefix + "_" + namePrefix + "_BODY_NAME";
            string fullDescString = EelPlugin.developerPrefix + "_" + namePrefix + "_BODY_DESCRIPTION";
            string fullOutroString = EelPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
            string fullFailureString = EelPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        {
            EelPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            EelPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            EelPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
